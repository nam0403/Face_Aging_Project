...
def safe_load_checkpoint(model_path: str, model_type: str) -> dict:
...
def build_and_load_ir(model_path: str, model_name: str = "ir_101", device: str = "cpu",
                      strict: bool = False) -> torch.nn.Module:
    back_bone_model = safe_load_checkpoint(model_path= model_path, model_type= model_name)
    back_bone_model.eval()
...
def main():
    ...
    model_configs = [
        ...
        ModelConfig(
            ...
            model_init=lambda:  build_and_load_ir(model_path="ir_se_101_temporal_best.pth", device="cuda"),
